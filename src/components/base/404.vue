  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">{{ subMsg }}</div>
        <a href="/" class="bullshit__return-home cursor">回到首页</a>
        <a class="bullshit__return-home cursor ms-2" @click="forwardAnyWhere">到处看看</a>
      </div>
    </div>
  </div>
</template>
...
const subMsg = ref('请检查您输入的URL是否正确，或单击下面的按钮返回主页。')
const message = computed(() => '这个页面不存在地球上...')
